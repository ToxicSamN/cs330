...
GLfloat tableDefinitions[numObjects][numTrianglesPerObject][6] = {
        // table top
        {
                {-0.500f,-0.250f, 0.000f,},
                {-0.500f,-0.250f,-0.013f,},
                { 0.500f,-0.250f, 0.000f,},
                { 0.500f,-0.250f,-0.013f,},
                {-0.500f, 0.250f, 0.000f,},
                {-0.500f,-0.250f,-0.013f,},
        ...
        // table front border
        {
                ...
                { 0.474f,-0.224f,-0.013f,},
                { 0.474f,-0.224f,-0.052f,},
                {-0.474f,-0.211f,-0.013f,},
                {-0.474f,-0.211f,-0.052f,},
                { 0.474f,-0.211f,-0.013f},
                { 0.474f,-0.211f,-0.052f},
        ...
        // table left border
        {
                {-0.474f,-0.211f,-0.013f,},
                {-0.474f,-0.211f,-0.052f,},
                {-0.461f,-0.211f,-0.013f,},
                {-0.461f,-0.211f,-0.052f,},
                {-0.474f, 0.211f,-0.013f,},
                {-0.474f, 0.211f,-0.052f,},
                {-0.461f, 0.211f,-0.013f,},
                {-0.461f, 0.211f,-0.052f,},
        ...
        {
                {-0.4285f,-0.2110f,-0.0130f,},
                {-0.4285f,-0.2110f,-0.5000f,},
                {-0.4610f,-0.2110f,-0.0130f,},
                {-0.4610f,-0.2110f,-0.5000f,},
                {-0.4285f,-0.1785f,-0.0130f,},
                {-0.4285f,-0.1785f,-0.5000f,},
                {-0.4610f,-0.1785f,-0.0130f,},
                {-0.4610f,-0.1785f,-0.5000f,},
        },
...
void UCreateVBO(){
    ...
    for (int i=0; i < numObjects; i++){
        for (int j=0; j < numTrianglesPerObject; j++){
            vertices;
        }
    }
