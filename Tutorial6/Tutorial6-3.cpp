...
#define WINDOW_TITLE "Sammy Shuck - Practice Activity 7: Textured Pyramid" //Window Title Macro
...
void URenderGraphics(void)
{
	...
	glm::mat4 view;
	view = glm::translate(view, glm::vec3(0.0f, 0.0f, -5.0f)); // Moves the world
