...
public:
    ...
    Shader(){
        ...
        glShaderSource(vertexShader, 1, &this->vertexShaderSource, NULL); // Attaches the vertex shader to the source code
        glCompileShader(vertexShader); // compiles the vertex shader

        // Fragment shader
        GLint fragmentShader = glCreateShader(GL_FRAGMENT_SHADER); // Creates the fragment shader
        glShaderSource(fragmentShader, 1, &this->fragmentShaderSource, NULL); // Attaches the fragment shader to the source code
        glCompileShader(fragmentShader); // compiles the fragment shader

        // Shader Program
        this->Program = glCreateProgram(); // Creates the shader program and returns an id
        glAttachShader(this->Program, vertexShader); // Attach vertex shader to the shader program
        glAttachShader(this->Program, fragmentShader); // Attach fragment shader to the shader program
...
/*
 * Camera object is a control mechanism that handles inputs and
 * calculates the corresponding vectors and matrices
 */
class Camera
{
...
void URenderGraphics(void) {
    ...
    /****** Use the Cube Shader and activate the Cube Vertexes Array Object for rendering and transforming *****/
    ...
    GLint lightPositionLoc = glGetUniformLocation(shader.Program, "lightPos");
